...
```
php composer.phar require "mr-muminov/yii2-charts" "*"
```
или

```
composer require mr-muminov/yii2-charts
```

или добавить в composer.json файл

```
"mr-muminov/yii2-charts": "*"
```
...
echo Charts::widget([
    'type'  => Charts::TYPE_PIE,
    'data'  => $dataPie,
    'options'   => []
]);
echo Charts::widget([
    'type'  => Charts::TYPE_DOUGHNUT,
    'data'  => $dataPie,
    'options'   => []
]);
echo Charts::widget([
    'type'  => Charts::TYPE_BUBBLE,
    'data'  => $dataBubble,
    'options'   => []
]);
```
